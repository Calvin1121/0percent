<template>
    ...
    <view class="progress-box" :style="{height: blockSize + 'rpx'}" @tap="handleTapFn">
        <view class="readers-slider" :style="{height: lineSize + 'rpx'}">
            <view class="readers-slider__value" :style="{
					width: posVal + '%',
					backgroundColor: activeColor
				}">
                <view class="rid-box" :style="{
						width: blockSize + 'rpx',
    ...
    <!-- #endif -->
    <!-- #ifdef APP-PLUS-NVUE -->
    <view class="progress-box" @touchstart="touchS" @touchmove="touchM" @touchend="touchE" @tap="handleTapWeex" :style="{ height: blockSize + 'rpx', paddingLeft: blockSize / 2 + 'rpx', paddingRight: blockSize / 2 + 'rpx' }">
        ...
        <view class="rid-box" ref="ridbox" :style="{
				width: blockSize + 'rpx',
				height: blockSize + 'rpx',
				backgroundColor: blockOuterColor,
